...
def register_wiki_tools(server):
    server.add_tool(wiki_list, name="mcp_swissknife_wiki_list")
    server.add_tool(wiki_get, name="mcp_swissknife_wiki_get")
    server.add_tool(wiki_get_by_slug, name="mcp_swissknife_wiki_get_by_slug")
    server.add_tool(wiki_search, name="mcp_swissknife_wiki_search")
    server.add_tool(wiki_create, name="mcp_swissknife_wiki_create")
    server.add_tool(wiki_edit, name="mcp_swissknife_wiki_edit")
    server.add_tool(wiki_delete, name="mcp_swissknife_wiki_delete")